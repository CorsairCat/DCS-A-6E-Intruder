...
--[[No Trim Now
    ...
    -- Systems
    {down = iCommandBatteryPower, name = _('Battery Power Switch'), category = _('Systems')},
    ...
    {down = Keys.DragParachute, name = _('Drag Chute DEPLOY'), category = _('Systems')},
...
--[[
    ...
    {action = Keys.LeftThrottleAxis         , name = _('Thrust Left')},
    -- iCommandPlaneThrustLeft			, name = _('Thrust Left')},
    {action = Keys.RightThrottleAxis        , name = _('Thrust Right')},
    -- iCommandPlaneThrustRight			, name = _('Thrust Right')},
