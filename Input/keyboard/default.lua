...
--[[
    ...
    {combos = {{key = 'P'}}, down = Keys.DragParachute, name = _('Drag Chute DEPLOY'), category = _('Systems')},
  ...
  --[[
    ...
    {combos = {{key = 'Home', reformers = {'RShift'}}}, down = Keys.LeftEngineIDLEPOS, name = _('Engine IDLE L'), category = _('Systems')},
    --{combos = {{key = 'End', reformers = {'RShift'}}}, down = Keys.LeftEngineOFF, name = _('Engines Stop'), category = _('Systems')},
    {combos = {{key = 'Home', reformers = {'RCtrl'}}}, down = Keys.RightEngineIDLEPOS, name = _('Engines IDLE R'), category = _('Systems')},
    --{combos = {{key = 'End', reformers = {'RCtrl'}}}, down = Keys.RighttEngineOFF, name = _('Engines Stop'), category = _('Systems')},
    ...
    {down = Keys.EnginesStart, name = _('Engines Start Button'), category = _('Systems')},
    {down = Keys.EnginesStop, name = _('Engines Stop Button'), category = _('Systems')},
    {down = Keys.EnginesStartStop, up = Keys.EnginesStartStopUp, name = _('Engines Button'), category = _('Systems')},
