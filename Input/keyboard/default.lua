...
--[[
  ...
  --[[
    ...
    {combos = {{key = 'Home', reformers = {'RShift'}}}, down = Keys.LeftEngineIDLE, name = _('Engines Start'), category = _('Systems')},
    {combos = {{key = 'End', reformers = {'RShift'}}}, down = Keys.LeftEngineOFF, name = _('Engines Stop'), category = _('Systems')},
    {combos = {{key = 'Home', reformers = {'RCtrl'}}}, down = Keys.RightEngineIDLE, name = _('Engines Start'), category = _('Systems')},
