...
--子页面
page_subsets  = {
	--[BASE]    		= LockOn_Options.script_path.."TEST/Indicator/base_page.lua", --底页面
	[INDICATION]    = LockOn_Options.script_path.."TEST/Indicator/indication_page.lua",	--指示页面
}

--页面集
pages = {
	{ INDICATION, }, --只有一个页面集，多页面集情况为增加这个数组
}
